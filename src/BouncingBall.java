...
public class BouncingBall {
    ...
    /*
        You drop a ball from a given height. After each bounce, the ball returns to some fixed proportion of its previous height.
     ...
     */
    public static double BouncingBall(double initial, double proportion){

        double bounces=0;
        double nuevaP=initial;

        while((nuevaP*proportion)>1){

            nuevaP=nuevaP*proportion;
            bounces++;
